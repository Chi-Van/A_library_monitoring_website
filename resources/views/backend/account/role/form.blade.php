<form role="form" method="post">
    <div class="box-body">
        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            ...
            <input type="text" name="name" class="form-control" value="{{old('name', isset($role->display_name) ? $role->display_name : '')}}" id="exampleInputEmail1" placeholder="Name">
    ...
    <div class="box-footer">
        ...
        <a href="{{ route('get.list.role') }}" class="btn btn-danger"><i class="fa fa-close"></i> Cancel</a>
    </div>
</form>