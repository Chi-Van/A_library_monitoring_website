                    ...
                    <form method="post" action="{{route('update.account', \Auth::user()->id)}}">
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="name" class="form-control" value="{{old('name', isset($user->name) ? $user->name : '')}}" id="exampleInputEmail1" placeholder="Name">
                            ...
                            <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="phone" class="form-control" value="{{old('phone', isset($user->phone) ? $user->phone : '')}}" id="exampleInputEmail1" placeholder="Phone">
