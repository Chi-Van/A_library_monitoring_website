        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">List Book Borrow : {{ $reader->r_name }}</h3>
                </div>
                <div class="box-header">
                    <form action="" class="form-inline">
                        <div class="col-md-12 default">
                            <div class="form-group col-md-4"><input type="text" class="form-control" name="name_book" placeholder="Name Book" value="{{ Request::get('name_book') }}" style="width: 100%"></div>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered">
                        <tbody>
                        <tr>
                            <td colspan="6" class="text-center"> <b>Total fine</b> </td>
