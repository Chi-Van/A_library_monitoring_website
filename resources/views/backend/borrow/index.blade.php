        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <a href="{{ route('get.create.borrow') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>
                    </div>
                </div>
                <div class="box-header">
                    <form action="" class="form-inline">
                        <div class="col-md-12 default">
                            <div class="form-group col-md-4"> <input type="text" class="form-control" name="code_borrow" placeholder="Code Borrow" value="{{ Request::get('code_borrow') }}" style="width: 100%"></div>
        ...
        <div class="modal-dialog modal-lg" style="width: 750px !important;">
            <div class="modal-content">
                ...
                <div class="modal-header" style="padding-top: 0px;">
                    ...
                    <h4 class="modal-title" style="margin-left: 32%; text-transform: uppercase; font-weight: bold;">List Borrow Reader</h4>
                </div>
                <div class="modal-body" id="content_view_borrow">

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger pull-right" data-dismiss="modal">Closed</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
