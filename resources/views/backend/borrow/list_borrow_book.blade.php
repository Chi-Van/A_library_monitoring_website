        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">List Book Borrow </h3>
                </div>
                <div class="box-header">
                    <form action="" class="form-inline">
                        <div class="col-md-12 default">
                            <div class="form-group col-md-3"><input type="text" class="form-control" name="name_book" placeholder="Name Book" value="{{ Request::get('name_book') }}" style="width: 100%"></div>
                            <div class="form-group col-md-3"> <input type="text" class="form-control" name="name_reader" placeholder="Name Reader" value="{{ Request::get('name_reader') }}" style="width: 100%"></div>
                            <div class="form-group col-md-3"> <input type="date" class="form-control" name="d_expiry_date" placeholder="Expiry Date" value="{{ Request::get('d_expiry_date') }}" style="width: 100%"></div>
                            <div class="form-group col-md-3">
                                <select name="d_status" class=" form-control" data-type="r_gender" style="width: 100%">
                                    <option value="" ></option>
                                    <option value="2" {{ Request::get('d_status') == 2 ? "selected='selected'" : "" }}>Paid</option>
                                    <option value="3" {{ Request::get('d_status') == 3 ? "selected='selected'" : "" }}>Lost</option>
                                    <option value="4" {{ Request::get('d_status') == 4 ? "selected='selected'" : "" }}>Damaged</option>
                                    <option value="5" {{ Request::get('d_status') == 5 ? "selected='selected'" : "" }}>Borrowing</option>
                                </select>
                            </div>
