...
<div class="register-box" style="width: 50%;">
    <div class="register-logo">
        <a href=""><b>Account information</b></a>
    </div>
...
W
            <div class="row">
                ...
                <div class="col-xs-6">
                    <a href="{{route('login')}}">
                        <a href="/" style="width: 40%; float: right;" class="btn btn-primary btn-google btn-flat"><i class="fa fa-fw fa-reply" style="font-size: 14px;"></i>  Hủy </a>
                    </a>
                </div>
                <div class="col-xs-6">
