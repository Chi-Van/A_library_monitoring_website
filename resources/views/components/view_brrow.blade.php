<div class="col-md-8 default">
    <p><b>Code Borrow : {{ $borrow->b_code_borrow }}</b></p>
    <p><b>Name Reader : {{ $borrow->reader !== null ? $borrow->reader->r_name : '' }}</b></p>
    @if (!empty( $borrow->b_note ))
        <p><b>Note : {{ $borrow->w_note  }}</b></p>
    @endif
    <p><b>Created : {{ $borrow->created_at  }}</b></p>
</div>
